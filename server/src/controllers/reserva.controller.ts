...
export const getReservasPasajero = (req: Request, res: Response) => {
    ...
    connection.query(query, PK_Usuario, (err, data) => {
        if(err) {
...
export const getReservasPasadasPasajero = (req: Request, res: Response) => {
...
export const getReservasFuturasPasajero = (req: Request, res: Response) => {
...
export const getReservasEmpresa = (req: Request, res: Response) => {
...
export const getReservasPasadasEmpresa = (req: Request, res: Response) => {
    ...
    connection.query(updateQuery, [PK_Empresa], (updateErr) => {
        if (updateErr) {
        ...
        connection.query(selectQuery, [PK_Empresa], (err, data) => {
            if (err) {
                console.error('Error al listar las reservas pasadas:', err);
                return res.status(500).json({ error: 'Error al listar las reservas pasadas' });
            } else {
...
// Agregar una reserva
export const addReserva = (req: Request, res: Response) => {
    ...
    connection.beginTransaction((err) => {
        ...
        connection.query(getCupoQuery, [PK_Viaje], (err, results) => {
            if (err) {
            ...
            connection.query(updateCupoQuery, [PK_Viaje], (err, result) => {
                if (err) {
...
interface Usuario {
    PK_Usuario: string; // Asegúrate de que este tipo coincida con tu modelo de datos
    email: string;
    nombre: string;
    apellido: string;
}
...
export const cancelarReserva = (req: Request, res: Response) => {
    ...
    connection.beginTransaction((err) => {
        ...
        connection.query(getViajeQuery, [PK_Reserva], (err, results) => {
            if (err) {
            ...
            connection.query(updateEstadoQuery, [PK_Reserva], (err, result) => {
                if (err) {
                ...
                connection.query(updateCupoQuery, [PK_Viaje], (err) => {
                    if (err) {
                        console.error('Error al actualizar el cupo disponible:', err);
                        return connection.rollback(() => {
                            res.status(500).json({ error: 'Error al actualizar el cupo disponible' });
                    ...
                    connection.query(getNotificacionQuery, [PK_Viaje], (err, notificaciones: Usuario[]) => {
                        if (err) {
                        ...
                        connection.query(getViajeDetallesQuery, [PK_Viaje], (err, viajeDetalles) => {
                            if (err) {
                            ...
                            notificaciones.forEach((usuario: Usuario) => {
                                ...
                                enviarCorreo(usuario.email, asunto, mensaje, (err) => {
                                    if (err) {
                                        ...
                                        connection.query(updateNotificacionQuery, [usuario.PK_Usuario, PK_Viaje], (err) => {
                                            if (err) {
...
const finalizarCancelacion = (res: Response, PK_Reserva: string, PK_Viaje: string) => {
