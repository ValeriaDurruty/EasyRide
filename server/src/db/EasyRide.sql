...
-- -----------------------------------------------------
-- Table `EasyRide`.`Empleado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `EasyRide`.`Empleado` (
  `PK_Empleado` INT NOT NULL AUTO_INCREMENT,
  `FK_Empresa` INT NOT NULL,
  PRIMARY KEY (`PK_Empleado`),
  INDEX `fk_Empleado_Empresa1_idx` (`FK_Empresa` ASC),
...
-- Para que los eventos se activen automaticamente al iniciar el servidor MySQL se debe configurar el event_scheduler en ON --
SHOW VARIABLES LIKE 'event_scheduler';

SET GLOBAL event_scheduler = ON;

-- Evento que actualiza el estado de las reservas a "Finalizado" si la fecha del viaje es anterior a la fecha actual --

DELIMITER $$

CREATE EVENT IF NOT EXISTS UpdateReservaEstado
